...
public class MySQLCredentials {
	...
	public MySQLCredentials(String host, String uname, String pword, String db) {
		this(host, uname, pword, db, 3306);
	}
	
	public MySQLCredentials(String host, String uname, String pword, String db, int port) {
		this.setHost(host);
